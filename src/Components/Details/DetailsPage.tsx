                ...
                <div className="container">
                    ...
                    <div className="details-page__row">
                        <div className="details-page__poster">
                            {!detailsItem.poster_path ? <Skeleton baseColor={"#5d5c5c"} highlightColor={"#858585"} className="details-page__skeleton"/> : <img
                        ...
                        <div className="details-page__info">
                            <ul>
                                ...
                                <li><strong>Genres</strong>: {detailsItem.genres.map( (item) => <span key={item.id} className='genre-pill details-pill'>{item.name} </span>)}</li>
                                <li><strong>Countries</strong>: {detailsItem.production_countries.map( (item) => <span key={item.iso_3166_1} className='genre-pill details-pill'>{item.name} </span>)}</li>
