...
const PopularPage = React.lazy(() => import('./Components/CategoryPages/Popular/PopularPage'));
const Search = React.lazy(() => import('./Components/Search/Search'));
const UpcomingPage = React.lazy(() => import('./Components/CategoryPages/Upcoming/UpcomingPage'));
